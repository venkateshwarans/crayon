...
>(
  (
    ...
    const tooltipLabel = useMemo(() => {
      ...
      if (labelFormatter) {
        return (
          <div className={clsx('crayon-chart-tooltip-label', labelClassName)}>
        ...
        <div className="crayon-chart-tooltip-content">
          {payload.map((item, index) => {
            ...
            return (
              <div
                key={item.dataKey}
                className="crayon-chart-tooltip-content-item"
              >
  ...
  (
    ...
    const payloadWithKeys = useMemo(
      () =>
        payload?.map((item) => ({
          ...item,
          uniqueKey: uniqueId(
            `chart-legend-${item.dataKey || item.value || ''}-`,
          ),
        })),
      [payload],
    )
    ...
    return (
      <div
        ...
        className={clsx(
          'crayon-chart-legend',
          `crayon-chart-legend--${verticalAlign}`,
          className,
        )}
      >
        {payloadWithKeys?.map((item) => {
          ...
          return (
            <div key={item.uniqueKey} className="crayon-chart-legend-item">
              ...
              <span className="crayon-chart-legend-item-label">
                {itemConfig?.label}
              </span>
            </div>
          )
